...
{{--here ends display of wishlist--}}
    ...
    <section id="displayselection">
        <div id="eframe">
            <div id="epadding">
                <img id="currentbrowse" class="browse" alt="{{$pic_info->title}}" src={{$pic_info->link}}>
            </div>
        </div>
        <div id="selectionoptions">
            <form method="POST" action="/pics/{{$id}}" >
                ...
                <fieldset>
                    ...
                    <label for="ematthick">select mat width</label>
            ...
            <div id="browse">
                <a href="/home" id="keepbrowse">keep browsing?</a>
            </div>
        </div> 
        <div id="purchase"> 
